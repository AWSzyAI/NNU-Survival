...
SYST = matplotlib.font_manager.FontProperties(fname='/Users/szy/Library/Fonts/SourceHanSerifCN-Regular-1.otf')
...
class NanjingMetro:
    ...
    def showPath(self, path,start,end):
        ...
        for i in path:
            nx.draw_networkx_nodes(G, pos, nodelist=[i], node_color='red', node_size=10, alpha=0.8)

        font_family = None
        for f in ['PingFang HK','Microsoft Sans Serif','SimHei', 'Microsoft YaHei', 'sans-serif','Songti SC']:
